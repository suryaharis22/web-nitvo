                ...
                <div className="hidden md:block md:w-auto">
                    <ul className="flex flex-col md:flex-row items-start md:items-center font-medium bg-primary-dark md:bg-transparent rounded-lg md:space-x-8 p-4 md:p-0 text-white transition-all duration-300">
                        <li>
                            <Link
                                href="/"
                                className={`block py-2 px-3 hover:text-warning-light transition-all duration-200 ${router.pathname === "/" ? "text-warning-light font-semibold" : ""}`}
                            >
                                Home
                            </Link>
                        </li>
                        <li>
                            <Link
                                href="/cek-transaction"
                                className={`block py-2 px-3 hover:text-warning-light transition-all duration-200 ${router.pathname === "/cek-transaction" ? "text-warning-light font-semibold" : ""}`}
                            >
                                Cek Transaction
                            </Link>
                        </li>
